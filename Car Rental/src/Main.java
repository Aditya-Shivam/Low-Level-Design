...
import Strategy.ConcreteClasses.CashPayment;
import Strategy.ConcreteClasses.CreditCardPayment;
import Strategy.ConcreteClasses.PaypalPayment;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Total amount: $" + reservation1.getAmount());
